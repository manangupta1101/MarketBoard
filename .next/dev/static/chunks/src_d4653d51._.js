...
function LinkIcon() {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(2);
    if ($[0] !== "13c5f3983d9a17577a4a9a635c4586ce3993fbf0f22d2da2eee6c23afb1606e9") {
        for(let $i = 0; $i < 2; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "13c5f3983d9a17577a4a9a635c4586ce3993fbf0f22d2da2eee6c23afb1606e9";
    }
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
...
;
;
const useOwnershipStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        ...
        getPendingRequests: ()=>{
            return get().promotionRequests.filter((r)=>r.status === 'pending');
        },
        getRequestsForTarget: (targetUserId)=>{
            return get().promotionRequests.filter((r)=>r.targetUserId === targetUserId);
        },
        canAddOwner: (currentOwnerCount)=>{
            return currentOwnerCount < __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MAX_OWNERS"];
        }
    }));
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
...
const TransferOwnershipModal = (t0)=>{
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(27);
    if ($[0] !== "7ef3a3d40e860334220a6ba0fa143eda01f2828cf3e5f3f4887f155b2cd7041b") {
        for(let $i = 0; $i < 27; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "7ef3a3d40e860334220a6ba0fa143eda01f2828cf3e5f3f4887f155b2cd7041b";
    }
...
const PendingRequestsSection = (t0)=>{
    ...
    const pendingRequests = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$ownership$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useOwnershipStore"])(_temp3);
    ...
    let t1;
    if ($[1] !== approvePromotion || $[2] !== currentUser || $[3] !== currentUserId || $[4] !== updateRole) {
        t1 = (requestId, targetUserId)=>{
            if (!currentUser) {
                return;
            }
    ...
    let t2;
    if ($[6] !== currentUser || $[7] !== currentUserId || $[8] !== rejectPromotion) {
        t2 = (requestId_0)=>{
            if (!currentUser) {
                return;
            }
    ...
    if ($[10] !== pendingRequests.length) {
        ...
        $[10] = pendingRequests.length;
        $[11] = t3;
    } else {
        t3 = $[11];
    }
    let t4;
    if ($[12] !== handleApprove || $[13] !== handleReject || $[14] !== pendingRequests) {
        let t5;
        if ($[16] !== handleApprove || $[17] !== handleReject) {
            t5 = (req)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s1(PendingRequestsSection, "xVnxSV1Bck1eoOXY7Epzo16DVFM=", false, function() {
    return [
...
const TeamPanel = (t0)=>{
    ...
    const { open, onClose } = t0;
    const currentUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$auth$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])(_temp8);
    const members = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$team$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTeamStore"])(_temp9);
    const updateRole = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$team$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTeamStore"])(_temp10);
    const removeMember = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$team$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTeamStore"])(_temp11);
    const createPromotionRequest = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$ownership$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useOwnershipStore"])(_temp12);
    const pendingRequests = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$ownership$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useOwnershipStore"])(_temp13);
    ...
    let t1;
    if ($[1] !== members) {
        t1 = members.filter(_temp14);
        $[1] = members;
        $[2] = t1;
    } else {
        t1 = $[2];
    }
    const ownerCount = t1.length;
    const isOwner = currentUser?.role === "owner";
    const isAdmin = currentUser?.role === "admin";
    const canManageRoles = isOwner || isAdmin;
    let t2;
    if ($[3] !== currentUser || $[4] !== isAdmin || $[5] !== isOwner || $[6] !== updateRole) {
        t2 = (memberId, memberName, newRole, currentRole)=>{
            if (!currentUser) {
                return;
            }
    ...
    let t3;
    if ($[8] !== createPromotionRequest || $[9] !== currentUser || $[10] !== pendingRequests) {
        t3 = (targetId, targetName)=>{
            if (!currentUser) {
                return;
            }
    ...
    const handleRequestAdminPromotion = t3;
    let t4;
    if ($[12] !== currentUser || $[13] !== isOwner || $[14] !== updateRole) {
        t4 = (targetId_0)=>{
    ...
    const handleTransferOwnership = t4;
    let t5;
    if ($[16] !== removeMember) {
        t5 = (memberId_0)=>{
    ...
    const handleRemoveMember = t5;
    if (!open || !currentUser) {
        return null;
    }
    let t6;
    if ($[18] !== currentUser.id || $[19] !== members) {
        let t7;
        if ($[21] !== currentUser.id) {
            t7 = (m_0)=>m_0.id !== currentUser.id && m_0.role !== "owner";
            $[21] = currentUser.id;
            $[22] = t7;
        } else {
            t7 = $[22];
        }
        t6 = members.filter(t7);
        $[18] = currentUser.id;
        $[19] = members;
        $[20] = t6;
    } else {
    ...
    let t10;
    if ($[28] !== isOwner) {
        t10 = isOwner && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
            type: "button",
    ...
    let t15;
    if ($[39] !== currentUser.id || $[40] !== currentUser.role) {
        t15 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(PendingRequestsSection, {
    ...
    let t17;
    if ($[45] !== canManageRoles || $[46] !== confirmRemove || $[47] !== currentUser.id || $[48] !== currentUser.role || $[49] !== handleRemoveMember || $[50] !== handleRequestAdminPromotion || $[51] !== handleRoleChange || $[52] !== isAdmin || $[53] !== members || $[54] !== ownerCount || $[55] !== pendingRequests) {
        let t18;
        if ($[57] !== canManageRoles || $[58] !== confirmRemove || $[59] !== currentUser.id || $[60] !== currentUser.role || $[61] !== handleRemoveMember || $[62] !== handleRequestAdminPromotion || $[63] !== handleRoleChange || $[64] !== isAdmin || $[65] !== ownerCount || $[66] !== pendingRequests) {
            t18 = (member)=>{
                ...
                const canRequestPromotion = isAdmin && !isSelf && !memberIsOwner && !memberIsAdmin && !pendingRequests.some((r_0)=>r_0.targetUserId === member.id);
                const hasPendingRequest = pendingRequests.some((r_1)=>r_1.targetUserId === member.id);
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                canChangeRole && assignableRoles.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                    ...
                                    children: assignableRoles.map(_temp15)
                                }, void 0, false, {
                                    fileName: "[project]/src/components/board/team-panel.tsx",
                                    lineNumber: 521,
                                    columnNumber: 787
            ...
            $[59] = currentUser.id;
            $[60] = currentUser.role;
            $[61] = handleRemoveMember;
            $[62] = handleRequestAdminPromotion;
            $[63] = handleRoleChange;
            $[64] = isAdmin;
            $[65] = ownerCount;
            $[66] = pendingRequests;
        ...
        $[47] = currentUser.id;
        $[48] = currentUser.role;
        $[49] = handleRemoveMember;
        $[50] = handleRequestAdminPromotion;
        $[51] = handleRoleChange;
        $[52] = isAdmin;
        $[53] = members;
        $[54] = ownerCount;
    ...
    let t19;
    if ($[70] !== t16 || $[71] !== t18) {
        t19 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {
    ...
    let t20;
    if ($[73] !== eligibleForTransfer || $[74] !== handleTransferOwnership || $[75] !== showTransferModal) {
        t20 = showTransferModal && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(TransferOwnershipModal, {
        ...
        $[73] = eligibleForTransfer;
        $[74] = handleTransferOwnership;
        $[75] = showTransferModal;
        $[76] = t20;
    } else {
        t20 = $[76];
    }
    let t21;
    if ($[77] !== t19 || $[78] !== t20 || $[79] !== t7) {
...
_s2(TeamPanel, "CirfdHuT5ELLw781lwG55Nodn5g=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$auth$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$team$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTeamStore"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$team$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTeamStore"],
...
function _temp10(s_1) {
    return s_1.updateRole;
}
function _temp11(s_2) {
    return s_2.removeMember;
}
function _temp12(s_3) {
    return s_3.createPromotionRequest;
}
function _temp13(s_4) {
    return s_4.getPendingRequests();
}
function _temp14(m) {
    return m.role === "owner";
}
function _temp15(r_2) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
        value: r_2,
        children: r_2.charAt(0).toUpperCase() + r_2.slice(1)
    }, r_2, false, {
        fileName: "[project]/src/components/board/team-panel.tsx",
        lineNumber: 635,
        columnNumber: 10
...
//# sourceMappingURL=src_d4653d51._.js.map