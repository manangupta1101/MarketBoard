...
const RequestDetailModal = ({ request: requestProp, open, onClose })=>{
    ...
    const canMoveForward = request.status !== 'closed' && request.status !== 'deleted' && (user.role === 'admin' || user.role === 'editor' && request.assigneeId === user.id);
...
;
;
const useOwnershipStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        ...
        canAddOwner: (currentOwnerCount)=>{
            return currentOwnerCount < __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MAX_OWNERS"];
        }
    }));
}),
...
const PendingRequestsSection = ({ currentUserId, currentUserRole })=>{
    const pendingRequests = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$stores$2f$ownership$2d$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useOwnershipStore"])((s)=>s.getPendingRequests());
...
//# sourceMappingURL=src_1131cf76._.js.map